...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" class="forumline" align="center">
	...
	<!-- END forumrow -->
	<tr>
		<td colspan="7" class="row2"><input class="boxes" type="text" name="{catrow.S_ADD_FORUM_NAME}" /> <input type="submit" class="button"  name="{catrow.S_ADD_FORUM_SUBMIT}" value="{L_CREATE_FORUM}" /></td>
	</tr>
	<tr>
		<td colspan="7" height="1" class="spaceRow"><img src="../templates/crazybat/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END catrow -->
	<tr>
		<td colspan="7" class="catBottom"><input class="boxes" type="text" name="categoryname" /> <input type="submit" class="button"  name="addcategory" value="{L_CREATE_CATEGORY}" /></td>
	</tr>
</table></form>
