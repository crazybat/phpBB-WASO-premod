...
<form method="post" name="post" action="{S_BANLIST_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" align="center" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2"><input class="boxes" type="text" class="boxes" name="username" maxlength="50" size="20" /> <input type="hidden" name="mode" value="edit" />{S_HIDDEN_FIELDS} <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="button" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row2"><input class="boxes" type="text" name="ban_ip" size="35" /></td>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row2"><input class="boxes" type="text" name="ban_email" size="35" /></td>
	</tr>
	<tr> 
	...
	<tr> 
	  <td class="catBottom" colspan="2" align="center"><input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="button" /></td>
	</tr>
</table></form>
