...
<table cellspacing="1" cellpadding="4" align="center" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2"><span class="gen"><input class="boxes" type="text" name="subject" size="45" maxlength="100" tabindex="2" class="boxes" value="{SUBJECT}" /></span></td>
	</tr>
	<tr> 
	  <td class="row1" align="right" valign="top"> <span class="gen"><b>{L_EMAIL_MSG}</b></span> 
	  <td class="row2"><span class="gen"> <textarea name="message" rows="15" cols="35" wrap="virtual" style="width:450px" tabindex="3" class="boxes">{MESSAGE}</textarea></span> 
	</tr>
	<tr> 
