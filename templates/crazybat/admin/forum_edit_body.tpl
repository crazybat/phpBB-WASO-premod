...
<form action="{S_FORUM_ACTION}" method="post">
  <table width="100%" cellpadding="4" cellspacing="1" class="forumline" align="center">
	...
	<tr> 
	  ...
	  <td class="row2"><input type="text" size="25" name="forumname" value="{FORUM_NAME}" class="boxes" /></td>
	</tr>
	<tr> 
	  <td class="row1">{L_FORUM_DESCRIPTION}</td>
	  <td class="row2"><textarea rows="5" cols="45" wrap="virtual" name="forumdesc" class="boxes">{DESCRIPTION}</textarea></td>
	</tr>
	<tr> 
	...
	<tr> 
	  ...
	  <td class="row2"><table cellspacing="0" cellpadding="1" >
		  ...
		  <tr> 
			...
			<td align="left" valign="middle">&nbsp;<input type="text" name="prune_days" value="{PRUNE_DAYS}" size="5" class="boxes" />&nbsp;{L_DAYS}</td>
		  </tr>
		  <tr> 
			<td align="right" valign="middle">{L_PRUNE_FREQ}</td>
			<td align="left" valign="middle">&nbsp;<input type="text" name="prune_freq" value="{PRUNE_FREQ}" size="5" class="boxes" />&nbsp;{L_DAYS}</td>
		  </tr>
	  </table></td>
	</tr>
	<tr> 
